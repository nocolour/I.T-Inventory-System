...
$total_stmt = $pdo->query("SELECT COUNT(*) FROM accessories");
$total_rows = $total_stmt->fetchColumn();
$total_pages = ceil($total_rows / $limit);

// Fetch paginated accessories from the database
$stmt = $pdo->prepare("SELECT * FROM accessories ORDER BY device_name ASC LIMIT :start, :limit");
...
<body>
    ...
    <table id="accessoriesTable">
        ...
        <tbody>
            <?php foreach ($accessories as $computer): ?>
                <tr>
